...
def objective(config, is_regression):
    ...
    return model_unique_name, metric_train, metric_test

def main(project_name, is_regression):
    with wandb.init(project=project_name) as run:
        model_unique_name, metric_train, metric_test = objective(run.config, is_regression)
