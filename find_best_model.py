...
print(len(runs))
summary_list, config_list, name_list, acc_OTI,distance_P14, distance_OT3, distance_OTI, synthetic_EC50_P14, synthetic_EC50_OT3, synthetic_EC50_OTI= [], [], [], [], [], [], [], [], [] , []  
    ...
    for i, run in enumerate(runs):
        ...
        if os.path.getsize(thisModelPath) == 0:
            ...
            if not is_regression:
                ...
                iterable = [(OTI_conf, OTI_conf_row_label, "OTI"),(P14_conf, P14_conf_row_label, "P14"), (OT3_conf,OT3_conf_row_label, "OT3")]
                EC50 = {
                    "N4" : -12.9,
                    "Q4" : -10.9,
                    "T4" : -9.5,
...
if not is_regression:
    ...
    this_min = [0.48,    0.6,    1.7 ,  1.1,    0.35,    1.5,    0.25]
    this_max = [0.69,   1.2,      2,  1.5,    1,      3,      0.7]
    ...
    for i, col in enumerate(runs_df.iloc[:,2:].columns):
        ...
        norm_df.loc[norm_df[col] > 1, col] = np.nan
        norm_df.loc[norm_df[col] < 0, col] = np.nan
...
iterable = [(P14_conf, P14_conf_row_label, "P14"), (OT3_conf,OT3_conf_row_label, "OT3")]
